        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id= "search-input" name = "search"placeholder="Type here...">
                </div>
            </div>
                ...
                <div class="table-responsive p-0">
                    <table class="table align-items-center mb-0">
                        ...
                        <tr>
                            ...
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-9">Description</th>
...
<script>
    ...
    function getRows() {
        ...
        $.get("/api/product/rows/json", data, function (result) {
            var jsonResault = JSON.parse(result);
            $.each(jsonResault.products, function (i, item) {
                $("#table-body").append(
                    "<tr>" +
                    "<td>" +
                    ...
                    "<a href='javascript:;' data-route='/product/delete?id=" + item.id + "' class='text-secondary font-weight-bold text-xs delete-action' data-toggle='tooltip' data-original-title='Edit user'>" +
                    "Delet" +
                    "</a>" +
